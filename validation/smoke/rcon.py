...
Copied from CobbleRaids rather than shared: the two repos are built and released separately, and a
test harness that cannot run without a sibling checkout is a harness nobody runs.
"""
